...
import chileez from './img/chileez.PNG';
        ...
        <div class="wrapper">
            ...
            <header>
                <div class="netflixLogo">
                    <a id="logoo" href="#home"><img src={newlogo} alt="Logo Image"/></a>
                </div>      
                <nav class="main-nav">                
                    <a href="#home">Home</a>
                ...
                <nav class="sub-nav">
                    ...
                    <div className="dropdown">
                        <button className="dropbtn">
                            <img src={chileez} alt="Chileez" className="netchileez"/><i class="fa fa-caret-down"></i>
                        </button>
                        <div className="dropdown-container">
                            <div className="dropmenu account-menu">
                                <a href="#"><img src={chileez} alt="Chileez" className="dropchileez"/>User</a>
                                <a href="#"><i class="fa-solid fa-pen"></i>Manage Profiles</a>
                            </div>
                            <hr></hr>
                            <div className="dropmenu help-center">
                                <a href="#"><i class="fa-solid fa-user"></i>Account</a>
                                <a href="#"><i class="fa-solid fa-circle-question"></i>Help Center</a>
                            </div>
                            <hr></hr>
                            <div className="dropmenu">
                                <a href="#" onClick={outClick}>Sign Out of Netflix</a>
                            </div>
                        </div>
                    </div>   
                </nav>      
